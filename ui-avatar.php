                                    ...
                                    <div class="col">
                                        <div class="img-group">
                                            <a class="user-avatar" href="#">
                                                <img src="assets/images/users/user-8.jpg" alt="user" class="thumb-sm rounded-circle">
                                            </a>
                                            <a class="user-avatar ms-n3" href="#">
                                                <img src="assets/images/users/user-5.jpg" alt="user" class="thumb-sm rounded-circle">
                                            </a>
                                            <a class="user-avatar ms-n3" href="#">
                                                <img src="assets/images/users/user-4.jpg" alt="user" class="thumb-sm rounded-circle">
                                            </a>
                                            <a class="user-avatar ms-n3" href="#">
                                                <img src="assets/images/users/user-6.jpg" alt="user" class="thumb-sm rounded-circle">
                                            </a>
                                    ...
                                    <div class="col">
                                        <div class="img-group">
                                            <a class="user-avatar me-1" href="#">
                                                <img src="assets/images/users/user-10.jpg" alt="user" class="rounded-circle thumb-sm">
                                            ...
                                            <a class="user-avatar me-1" href="#">
                                                <img src="assets/images/users/user-1.jpg" alt="user" class="rounded-circle thumb-sm">
                                                <span class="avatar-badge online"></span>
                                            </a>
                                        </div><!--end img-group-->                                            
                                    </div><!--end col-->
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a class="user-avatar me-2" href="#">
                                    <img src="assets/images/users/user-10.jpg" alt="user" class="thumb-xl rounded-circle">
                                </a>
                                <a class="user-avatar me-2" href="#">
                                    <img src="assets/images/users/user-10.jpg" alt="user" class="thumb-lg rounded-circle">
                                </a>
                                <a class="user-avatar me-2" href="#">
                                    <img src="assets/images/users/user-10.jpg" alt="user" class="thumb-md rounded-circle">
                                </a>
                                <a class="user-avatar me-2" href="#">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a class="user-avatar me-2" href="#">
                                    <img src="assets/images/users/user-5.jpg" alt="user" class="thumb-xl rounded">
                                </a>
                                <a class="user-avatar me-2" href="#">
                                    <img src="assets/images/users/user-5.jpg" alt="user" class="thumb-lg rounded">
                                </a>
                                <a class="user-avatar me-2" href="#">
                                    <img src="assets/images/users/user-5.jpg" alt="user" class="thumb-md rounded">
                                </a>
                                <a class="user-avatar me-2" href="#">
                                    <img src="assets/images/users/user-5.jpg" alt="user" class="thumb-sm rounded">
                                </a>
                                <a class="user-avatar me-2" href="#">
                                    <img src="assets/images/users/user-5.jpg" alt="user" class="thumb-xs rounded">
                                </a>
                            </div><!--end card-body-->
                        </div><!--end card-->
                    </div><!--end col-->
