...
<head>
    ...
    <link href="assets/plugins/animate/magic.min.css" rel="stylesheet" />
...
<?php include 'partials/menu.php';  ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-5">
                                    <div class="row">
                                        <div id="content"
                                            class="col-lg-6 mx-auto text-center button-list container-magic-bottom container text-center">
                                        <div style="height: 450px;" data-simplebar>
                                            ...
                                            <button type="button" class="btn btn-de-primary btn-sm btn-animation"
   ...
   <!-- Javascript  -->
   <script src="assets/pages/animation.init.js"></script>
   <!-- App js -->
