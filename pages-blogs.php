                            ...
                            <div class="card-body">
                                <div class="blog-card">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="meta-box">
                                            <div class="media">
                                                <img src="assets/images/users/user-7.jpg" alt="" class="thumb-sm rounded-circle me-2">                                       
                                                <div class="media-body align-self-center text-truncate">
                            ...
                            <div class="card-body">
                                <div class="blog-card">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="meta-box">
                                            <div class="media">
                                                <img src="assets/images/users/user-8.jpg" alt="" class="thumb-sm rounded-circle me-2">                                       
                                                <div class="media-body align-self-center text-truncate">
