                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/products/02.png" alt="" class="d-block mx-auto my-4" height="150">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/products/06.png" alt="" class="d-block mx-auto my-4" height="150">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
                                            <p class="text-muted mb-2">Fashion & Life Style</p>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/products/01.png" alt="" class="d-block mx-auto my-4" height="150">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img src="assets/images/products/07.png" alt="" class="d-block mx-auto my-4" height="150">
                                    <div class="d-flex justify-content-between align-items-center my-4">
                                        <div>
