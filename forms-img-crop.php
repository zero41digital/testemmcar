...
<head>
    ...
    <link href="assets/plugins/cropper/css/cropper.css" rel="stylesheet" type="text/css" />
    <link href="assets/plugins/cropper/css/main.css" rel="stylesheet" type="text/css" />
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="img-container mb-0">
                                    <img id="image" src="assets/images/small/img-1.jpg" alt="Picture">
                                </div>
                            </div><!--end card-body-->
                        </div><!--end card-->
                        <div id="actions">
