...
<html lang="en">
    ...
    include 'partials/title-meta.php'; ?>
        ...
        <link href="assets/plugins/splide/splide.min.css" rel="stylesheet" type="text/css" />
...
<?php include 'partials/menu.php';  ?>
                                                ...
                                                <div class="splide__track">
                                                      <ul class="splide__list">
                                                          <li class="splide__slide">
                                                              <img src="assets/images/products/01.png" alt="" class="mx-auto  d-block" height="300">
                                                          </li>
                                                          <li class="splide__slide">
                                                              <img src="assets/images/products/02.png" alt="" class="mx-auto  d-block" height="300">
                                                          </li>
                                                          <li class="splide__slide">
                                                              <img src="assets/images/products/03.png" alt="" class="mx-auto  d-block" height="300">
                                                          </li>
                                                      </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <img src="assets/images/products/05.png" alt="" class="d-block mx-auto my-4" height="150">
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <img src="assets/images/products/03.png" alt="" class="d-block mx-auto my-4" height="150">
                                            <div class="d-flex justify-content-between align-items-center my-4">
                                                <div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <img src="assets/images/products/04.png" alt="" class="d-block mx-auto my-4" height="150">
                                            <div class="d-flex justify-content-between align-items-center my-4">
                                                <div>
        ...
        <script src="assets/pages/splide.init.js"></script>
        <!-- App js -->
